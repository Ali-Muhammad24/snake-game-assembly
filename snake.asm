...
; Score is in the form of number (25), but we have to show it as ASCII digits on the screen. so we break the words in digits and push them on the stack in reverse order 
